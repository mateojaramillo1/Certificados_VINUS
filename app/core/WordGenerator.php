...
class WordGenerator
{
    ...
    public function generarCertificado($empleado, $incluirSalario = true)
    {
        ...
        $f_ingreso_texto = $fechaIngObj->format('d') . " de " . $meses[(int)$fechaIngObj->format('n')] . " de " . $fechaIngObj->format('Y');

        // --- REEMPLAZO DE VARIABLES ---
        // Usamos los nombres de columna de tu base de datos phpMyAdmin
